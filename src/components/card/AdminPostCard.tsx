...
function AdminPostCard({ post }: IPostCardProps) {
  ...
  return (
    <div className=" bg-white dark:bg-dark-light p-5  rounded-lg shadow dark:text-white">
      <div className="flex flex-col md:flex-row  gap-2">
        <img className=" md:h-40 rounded-md w-[40%]" src={post.thumbnail} alt="" />
